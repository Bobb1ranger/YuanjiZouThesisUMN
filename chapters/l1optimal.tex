...
L \in \mathbb{R}^{n_u \times n_y} \times \mathcal{F}_N \cap \mathcal{S}.
\end{align}
\end{subequations}
\end{opt}
...
\begin{figure}[hb]
    \centering
    \includegraphics[width= 0.75\linewidth]{figures/DisCtrlfigure/_3nodeEx_L1result.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width= 0.75\linewidth]{figures/DisCtrlfigure/_3nodeEx_unco_L1result.png}
